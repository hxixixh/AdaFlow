...
from adaflow.model.diffusion.conv1d_components import (
    Downsample1d, Upsample1d, Conv1dBlock)
from adaflow.model.diffusion.positional_embedding import SinusoidalPosEmb
...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, 
            ...
            local_cond=None, global_cond=None, return_feat=False, **kwargs):
        """
        x: (B,T,input_dim)
